...
public class SupportController implements Initializable {
    ...
    private void handleSendButton(ActionEvent event) {
        ...
        SendEmail(emailid.getText(), password.getText(), "realityvisionisamm@gmail.com", subject.getText() ,message.getText());
    }
    ...
    private void   SendEmail(String user, String pass, String to, String sub, String msg)
    {
        Properties prop= new Properties();
         ...
         try
         {
             ...
             message1.setFrom( new InternetAddress("Espaly@gmail.com"));
